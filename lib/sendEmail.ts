    ...
    html: `
      ...
      <html>
        <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 10px; font-weight: bold; width: 140px; color: #374151;">Name:</td>
              <td style="padding: 10px; color: #1E1E2E;">${name}</td>
            </tr>
            <tr style="background: #F7F8FC;">
              <td style="padding: 10px; font-weight: bold; color: #374151;">Email:</td>
            ...
            <tr style="background: #F7F8FC;">
              ...
              <td style="padding: 10px; color: #1E1E2E;">${company || 'Not provided'}</td>
            </tr>
            <tr>
              <td style="padding: 10px; font-weight: bold; color: #374151;">Service:</td>
              <td style="padding: 10px; color: #1E1E2E;">${service || 'Not provided'}</td>
            </tr>
            <tr style="background: #F7F8FC;">
              <td style="padding: 10px; font-weight: bold; color: #374151; vertical-align: top;">Message:</td>
              <td style="padding: 10px; color: #1E1E2E; white-space: pre-wrap;">${message || 'Not provided'}</td>
            </tr>
          </table>
          <p style="margin-top: 24px; font-size: 12px; color: #9CA3AF;">
            Sent from your website quote form at ${new Date().toLocaleString('en-IN')}
          </p>
        </body>
      </html>
    `,
