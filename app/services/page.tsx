...
export const metadata: Metadata = {
  title: 'Services',
  description:
    'Explore Algokami Tech Solutions services for web development, e-commerce, web apps, SEO, and digital growth.',
  alternates: {
    canonical: '/services',
  },
}
    ...
    <main className="page-shell">
      <section className="page-hero">
        <div className="container">
          ...
          <h1>Built-to-Rank Digital Services</h1>
          <p>
            Browse the core services we offer for businesses that need stronger visibility,
            faster delivery, and reliable long-term growth.
          </p>
        </div>
      </section>
          ...
          <FadeInView>
            <div className="section-header">
              ...
              <p className="section-subtitle">
                Each service page can now be discovered directly by Google through this landing page.
              </p>
            </div>
          </FadeInView>
